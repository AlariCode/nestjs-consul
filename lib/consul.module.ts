...
import { Module, DynamicModule, Provider, Global, InternalServerErrorException } from '@nestjs/common';
...
export class ConsulModule {
  ...
  private static createAsyncOptionsProvider<T>(options: IConsulAsyncConfig<T>): Provider {
    return {
      provide: ConsulService,
      useFactory: async (...args: any[]) => {
        if (typeof options.useFactory !== 'function') {
          throw new InternalServerErrorException('useFactory must be a function');
        }
